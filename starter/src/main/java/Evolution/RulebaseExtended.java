...
//	}
    ...
    private static class BaselinePrefixPool {
        ...
        private static int[] vandeberghChromossome = {46, 37, 13, 14, 19, 29}; //Note: actual Van den Bergh uses DiscardProbablyUselessCard(1.0) -not on rulebase- rather than DiscardUselessCard -27
