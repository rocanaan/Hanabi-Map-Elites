...
public class GeneticAlgorithm2 {
	...
	public GeneticAlgorithm2(int populationSize, double mutationRate, double crossoverRate, int elitismCount,
			int tournamentSize) {
...
//        }
        ...
        IndividualDescriptor[] fitnessOfPopulation =  FitnessEvaluation.calculateDescriptors(population, numGames, mirror, testPool, minNumPlayers, maxNumPlayers, rulebaseStandard);
        ...
        for (int i = 0; i<fitnessOfPopulation.length; i++) {
        		double fitness = fitnessOfPopulation[i].fitness;
        ...
        for (int i = 0; i<population.getIndividuals().length; i++) {
        		System.out.println("Individual [" +population.getIndividual(i).toString() + "] fitness = " + fitnessOfPopulation[i].fitness + " dim 1 " + fitnessOfPopulation[i].coordinates.get(0) + " dim 2 " + fitnessOfPopulation[i].coordinates.get(1));	
//        		System.out.println("dim1 = " + fitnessOfPopulation[i].coordinates.get(0));	
//        		System.out.println("dim2 = " + fitnessOfPopulation[i].coordinates.get(1));	
