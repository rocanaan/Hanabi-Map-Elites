 ...
 */
public class HumanControlledStateEvaluator implements Agent {

    private Random random;

    public HumanControlledStateEvaluator() {
    ...
    public Action doMove(int playerID, GameState gameState) {
        ...
        showEvaluation( playerID,  gameState);
...
//        System.out.println(r.couldFire(1, gameState));
    ...
    public void showEvaluation(int playerID, GameState gameState) {
    		System.out.println("State evaluation:");
        GamestateEvaluator eval = new GamestateEvaluator (playerID, gameState);
        int numPlayers = gameState.getPlayerCount();
        System.out.println("Player Count: " +  numPlayers);
        System.out.println("Deck size: " + eval.getDeckSize());
        System.out.println("Information tokens: " + eval.getInformation());
        System.out.println("Lives left: " + eval.getLives());
        
        System.out.println("Playability scores:");
        for (int i = 0; i<5 ; i++) {
        		int currentPlayer = (playerID+i)%5;
        		System.out.println("Player " + currentPlayer + " " + eval.getProbabiltyPlayable(currentPlayer));
        }
        System.out.println("Uselessnes scores:");
        for (int i = 0; i<5 ; i++) {
        		int currentPlayer = (playerID+i)%5;
        		System.out.println("Player " + currentPlayer + " " + eval.getProbabiltyUseless(currentPlayer));
        }
        System.out.println("Necessity scores:");
        for (int i = 0; i<5 ; i++) {
        		int currentPlayer = (playerID+i)%5;
        		System.out.println("Player " + currentPlayer + " " + eval.getProbabiltyNecessary(currentPlayer));
        }

//        System.out.println(eval.getProbabiltyPlayable(playerID));
//        System.out.println(eval.getProbabiltyUseless(playerID));
//        System.out.println(eval.getProbabiltyNecessary(playerID));
//        System.out.println(eval.getProbabiltyPlayable(playerID+1));
//        System.out.println(eval.getProbabiltyUseless(playerID+1));
//        System.out.println(eval.getProbabiltyNecessary(playerID+1));
    }
