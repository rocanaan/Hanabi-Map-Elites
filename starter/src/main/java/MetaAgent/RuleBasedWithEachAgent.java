...
public class RuleBasedWithEachAgent {
...
//				new AgentPlayer("8", AgentUtils.buildAgent("mctsND"))
    ...
    public static void main( String[] args )
    {
        ...
        Player you = new AgentPlayer("you", AgentUtils.buildAgent("iggi"));
    	for(int i = 0; i<400; i++) {
    		statsSummary.add(runTestGames(String.valueOf(i),you));
    ...
    public static StatsSummary runTestGames(String name, Player you) {
