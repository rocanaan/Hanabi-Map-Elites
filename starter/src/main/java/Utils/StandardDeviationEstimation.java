...
public class StandardDeviationEstimation 
{
    public static void main( String[] args )
    {
        ...
        // Best agent on the GA
 		...
 		HistogramAgent HailMaryHAgent = Rulebase.makeAgent(rules3);
 		...
 		HistogramAgent evolvedMixed1 = Rulebase.makeAgent(rules4);
 		...
 		HistogramAgent evolvedMixed2 = Rulebase.makeAgent(rules5);
...
// 		population.add(new AgentPlayer("Partial Evolved Mixed 4", PartialEvolvedMixed4));
 		...
 		Vector<AgentPlayer> baseline = Rulebase.GetBaselineAgentPlayers();
